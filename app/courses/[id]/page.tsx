...
export default function CourseDetailPage({ params }: { params: { id: string } }) {
  ...
  // Replace course data with:
  const course = coursesData.courses.find((c) => c.id === Number.parseInt(courseId)) as Course | undefined
                          ...
                          {unit.modules.map((module, moduleIndex) => (
                            <div
                              ...
                              className={`flex items-center justify-between p-3 rounded-lg border ${
                                module.locked ? "opacity-50 cursor-not-allowed" : "hover:bg-muted/50 transition-colors"
                              }`}
                            >
                              {/* module content */}
                            </div>
